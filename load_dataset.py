...
theta_rnd, feature_inds_rnd, thresholds_rnd = random_booster(x_train, y_train, 200)
theta_stp, feature_inds_stp, thresholds_stp = stump_booster(x_train, y_train, 200)
...
f=open("REPORT_FULL_PLOT_2.json", "w")
